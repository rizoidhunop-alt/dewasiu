...
// Variables
const rootDomain = "rizoidhunop.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "dewasiuio"; // Ganti dengan nama workers kalian
const apiKey = ""; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = ""; // Ganti dengan email yang kalian gunakan
const accountID = "0d53b59a8555ee20472c0cb94a3ad2bc"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
